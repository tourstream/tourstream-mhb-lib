              ...
              <SliderElement image={media[key].image} key={key}>
                ...
                <figcaption>
                  <div className="caption-wrapper">
                    {media[key].header && <div className="caption-header" dangerouslySetInnerHTML={{ __html: media[key].header }} />}
                    {media[key].body && <div className="caption-body" dangerouslySetInnerHTML={{ __html: media[key].body }} />}
                  </div>
                </figcaption>
                }
              </SliderElement>
