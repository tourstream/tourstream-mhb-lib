      ...
      if (hotel) {
        ...
        Object.keys(store).map(key => {
          try {
            ...
            const translated_hotels = (typeof i18n.getFixedT(key)('hotels') === 'string') ? JSON.parse(i18n.getFixedT(key)('hotels')) : i18n.getFixedT(key)('hotels')
