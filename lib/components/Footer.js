    ...
    return (
      <FooterWrapper>
        <div className="container">
          ...
          <FooterLinks>
            <Link to={getLanguage() + t('footer.link.jobs.url')}>{t('footer.link.jobs.text')}</Link>
            <Link to={getLanguage() + t('footer.link.contact.url')}>{t('footer.link.contact.text')}</Link>
            <Link to={getLanguage() + t('footer.link.imprint.url')}>{t('footer.link.imprint.text')}</Link>
            <Link to={getLanguage() + t('footer.link.privacy.url')}>{t('footer.link.privacy.text')}</Link>
          </FooterLinks>
        </div>
      </FooterWrapper>
    )
