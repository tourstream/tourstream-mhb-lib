              ...
              <FooterBrandLogos>
                ...
                <figure>
                  <a href={t('footer.brands.logo.labranda.url')}>
                    <LazyLoad height={75} offset={300}>
                      <img src={theme.get('footerBrandLogoLabranda')} alt={t('footer.brands.logo.labranda.alt')} />
                    </LazyLoad>
                    <figcaption>
                ...
                <figure>
                  <a href={t('footer.brands.logo.designplus.url')}>
                    <LazyLoad height={75} offset={300}>
                      <img src={theme.get('footerBrandLogoDesignPlus')} alt={t('footer.brands.logo.designplus.alt')} />
                    </LazyLoad>
                    <figcaption>
                ...
                <figure>
                  <a href={t('footer.brands.logo.kairaba.url')}>
                    <LazyLoad height={75} offset={300}>
                      <img src={theme.get('footerBrandLogoKairaba')} alt={t('footer.brands.logo.kairaba.alt')} />
                    </LazyLoad>
                    <figcaption>
                ...
                <figure>
                  <a href={t('footer.brands.logo.clubsei.url')}>
                    <LazyLoad height={75} offset={300}>
                      <img src={theme.get('footerBrandLogoClubSei')} alt={t('footer.brands.logo.clubsei.alt')} />
                    </LazyLoad>
                    <figcaption>
                      {t('footer.brands.logo.clubsei.caption')}
                    </figcaption>
                  </a>
                </figure>
                <figure>
                  <a href={t('footer.brands.logo.lemonandsoul.url')}>
                    <LazyLoad height={75} offset={300}>
                      <img src={theme.get('footerBrandLogoLemonsoul')} alt={t('footer.brands.logo.lemonandsoul.alt')} />
                    </LazyLoad>
                    <figcaption>
                      {t('footer.brands.logo.lemonandsoul.caption')}
                    </figcaption>
                  </a>
                </figure>
              </FooterBrandLogos>
