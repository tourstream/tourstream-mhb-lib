...
const FooterWrapper = styled.footer`
  ...
  @media (min-width: 1200px) {
    font-size: ${props => props.theme.baseFontSize*1.5}px || '24px';
  }
...
const FooterSocialLinks = styled.div `
  ...
  img {
    height: ${props => 30 / props.theme.baseFontSize}rem;
    width: ${props => 30 / props.theme.baseFontSize}rem;
  }
  ...
  .social-link {
    ...
    font-size: ${props => 30 / props.theme.baseFontSize}rem;
    width: ${props => 30 / props.theme.baseFontSize}rem;
    height: ${props => 30 / props.theme.baseFontSize}rem;
              ...
              <FooterBrandLogos>
                ...
                <figure>
                  <a href={t('footer.brands.logo.labranda.url')}>
                    <LazyLoad><img src="/shared/images/logos/labranda_logo_white.svg" alt={t('footer.brands.logo.labranda.alt')} /></LazyLoad>
                    <figcaption>
          ...
          <div className="row">
            <FooterSocialLinks>
              ...
              {/**
               <ul>
               <li>
               <a className="social-link social-link-instagram" href={t('link.instagram')}></a>
               </li>
               <li>
               <a className="social-link social-link-facebook" href={t('link.facebook')}></a>
               </li>
               </ul>
              **/}
            </FooterSocialLinks>
