...
const StyledHeader = styled.header`
  ...
  */
  nav {
    ...
    padding-left: ${props => 20 / props.theme.get('baseFontSize')}rem;
    padding-right: ${props => 20 / props.theme.get('baseFontSize')}rem;
  }
...
const HeaderLogo = styled.div`
  ...
  a {
    ...
    display: inline-block;
    padding: 0;
    margin: ${props => 15 / props.theme.get('baseFontSize')}rem 0;
    height: ${props => 55 / props.theme.get('baseFontSize')}rem;
  }
  img {
    height: 100%;
    border: 0;
...
const SecondaryLogo = styled.div`
  position: absolute;
  display: inline-block;
  top: ${props => 20 / props.theme.get('baseFontSize')}rem;
  right: 50%;
  transform: translateX(50%);
  @media (min-width: 992px) {
    right: 50%;
    transform: translateX(${props => 260 / props.theme.get('baseFontSize')}rem);
  }
...
class Header extends Component {
  ...
  render () {
    const { i18n, languages, theme } = this.props
